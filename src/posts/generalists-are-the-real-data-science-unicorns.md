...
description: 'In the race for greater specialisation within data science, have we overlooked how important it is to maintain a more general set of skills?'
permalink: posts/{{ title | slug }}/index.html
date: '2019-02-10'
tags: ['data']
---
![Unicorn mug](/images/unicorn-mug.jpg)
...
Then maybe, just maybe, over time and through experience, one of my Total Footballers can find they want to specialise and move on to a more suitable home for that stage of their career. **Horses for courses.**

I'd be willing to wager that the other skills they'll have picked up in the meantime will never be wasted even if they do go on to specialise and that, for me, makes it all the more reason to keep looking for my own unicorns wherever I might find them.