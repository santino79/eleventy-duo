...
description: 'Moving from being a data analyst to a manager is often seen as a promotion but we need to consider it more like a career change.'
date: '2024-01-23'
permalink: becoming-manager-isnt-promotion-career-change/index.html
tags: ['data']
---
![Manager sitting at a table](/images/manager-team-table.jpg)
...
-  the trials and tribulations of moving from being a [data IC to data manager](/becoming-manager-isnt-promotion-career-change/)
- why we might think about going [back to Individual Contributor](/can-i-go-back-data-ic-after-being-manager/) again
- [what could go very wrong](/what-can-go-wrong-moving-back-data-ic-from-manager/) with that move.
- and, ultimately, what could make it a [very good decision](/why-should-we-move-back-data-ic-from-manager/) for us, and for those we work for.

*Main Photo by [rawpixel](https://unsplash.com/photos/a2VqhP3d4Vg?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](ttps://unsplash.com/search/photos/manager?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)*