...
description: "We take a run through what can go wrong with the move back to data IC from data manager role"
permalink: what-can-go-wrong-moving-back-data-ic-from-manager/index.html
date: '2024-03-30'
tags: ['data']
---
![Clouds](/images/zbynek-burival-8iZG31eXkks-unsplash.jpg)

_This is Part 3 of a 4 part series, detailing the trials and tribulations of moving from being a [data IC to data manager](/becoming-manager-isnt-promotion-career-change/) and why we might think about going [back to Individual Contributor](/can-i-go-back-data-ic-after-being-manager/) again._

### Quick Recap

In [**Part 1**](/becoming-manager-isnt-promotion-career-change/), we looked at the reason why we'd move over from being a data IC (in my case, an analyst) to becoming a manager of data analysts.
_TL;DR glass ceiling, money, seemed like the right thing to do at the time._

In [**Part 2**](/can-i-go-back-data-ic-after-being-manager/), we looked at why that move might have started to turn sour and make us cast wistful glances back across the aisle to our old IC stomping ground.
...
And then, in [Part 4](/why-should-we-move-back-data-ic-from-manager/), we'll do the positive ending to bring this all home.
...
Check out There And Back Again Part 4: [Why Should We Move Back To Data IC Role After Being A Manager?](/why-should-we-move-back-data-ic-from-manager/)
